    ...
    <div className="flex flex-col gap-10">
      <section className="flex flex-col gap-4">
        ...
        <p className="text-muted-foreground max-w-2xl">
          SchoolScope England brings together official school records, academy trust structures,
          published performance statistics and admissions catchment areas from government sources,
          in one place.
        </p>
      ...
      <section aria-label="Dataset overview" className="grid gap-4 sm:grid-cols-3">
        <Card>
          <CardHeader>
            <CardDescription>Open schools</CardDescription>
            <CardTitle className="text-2xl">
              {stats.ok ? formatNumber(stats.data.schoolCount) : "Not available"}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle className="text-2xl">
              {stats.ok ? formatNumber(stats.data.localAuthorityCount) : "Not available"}
            </CardTitle>
          </CardHeader>
        </Card>
      </section>
      ...
      <section aria-label="What you can do here" className="grid gap-4 sm:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Filter by phase, local authority, admissions type and published performance metrics.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/schools" className="text-primary text-sm underline underline-offset-2">
              Browse schools
            </Link>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              See whether an address falls inside a school&apos;s published priority area, where a
              local authority has made that boundary available.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/admissions" className="text-primary text-sm underline underline-offset-2">
              Go to admissions
            </Link>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              View schools and available catchment boundaries together on an interactive map.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/map" className="text-primary text-sm underline underline-offset-2">
              Open the map
            </Link>
          </CardContent>
        </Card>
